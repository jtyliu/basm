...
# FunctionArgsWorkflow = Workflow().clone("FunctionArgsWorkflow")
# FunctionArgsWorkflow.register_activity(Activity("FunctionArg",action=function_arg_cc))
# FunctionArgsWorkflow.insert('core.function.analyzeTailCalls',['FunctionArg'])